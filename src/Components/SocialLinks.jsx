const SocialLinks = () => {
  ...
  return (
    <div className="space-y-6">
      <h4 className="text-xl text-heading font-semibold">Find Us On</h4>
      <div className="border border-[#E7E7E7] rounded-md divide-y divide-[#E7E7E7]">
        <a href="https://web.facebook.com/" className="flex items-center gap-3 p-4">
          {facebookIcon}
          <h5 className="text-heading text-base font-medium">Facebook</h5>
        </a>
        <a href="https://twitter.com/" className="flex items-center gap-3 p-4">
          {twitterIcon}
          <h5 className="text-heading text-base font-medium">Twitter</h5>
        </a>
        <a href="https://www.instagram.com/" className="flex items-center gap-3 p-4">
          {instagramIcon}
          <h5 className="text-heading text-base font-medium">Instagram</h5>
        </a>
      </div>
    </div>
  );
